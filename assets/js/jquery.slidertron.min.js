...
function a(){if(0!=M.advanceDelay){if(!z)switch(M.advanceDirection){case"random":var e,t=j.length-1;if(M.seamlessWrap&&"slide"==M.mode&&(t-=3),2>t)break;for(;(e=Math.ceil(Math.random()*t))==R;);m(e);break;case"backward":h();break;case"forward":default:if(M.advanceLoop)f();else{var t=j.length,e=parseInt(R);M.seamlessWrap?(t-=4,e-=1):e+=1,t>e?f():r()}}k=window.setTimeout(a,M.advanceDelay)}}
...
function u(){m(C)}
function v(){m(g)}
function f(){var e=!1;_?e=parseInt(R)+M.navSize:(g>R?e=parseInt(R)+M.navSize:(M.navWrap||q)&&(e=C),e>g?e=g:0>e&&(e=0)),e!==!1&&m(e)}
function h(){var e=!1;_?e=parseInt(R)-M.navSize:(R>C?e=parseInt(R)-M.navSize:M.navWrap&&(e=g),e>g?e=g:0>e&&(e=0)),e!==!1&&m(e)}
...
function w(){if(M.disabledNavClass!==!1&&M.navWrap!==!0){for(x in H)H[x]&&H[x].removeClass(M.disabledNavClass).css("cursor","pointer");var e=new Array;R==C&&(e.push(L),e.push(I)),R==g&&(e.push(y),e.push(T));for(x in e)e[x]&&e[x].addClass(M.disabledNavClass).css("cursor","default")}}
